...
tic
[lags, r_0, r_su] = TFCCA_lagCC(x1(1:10,:), x2(1:10,:), fs, downsample_ratio, ...
...
win = 40;
tic
TFCCA(x1(2,:), x2(2,:), fs, downsample_ratio, win, 0.08, 19.9, false, "lag", 0, "surrogate_num", 100, "plot", false);
toc
